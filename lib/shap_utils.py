...
from LGBM import TrainResults, train_data_series
from data_series import DataSerie
...
def explain_model(
    ...
    for fold in folds:
        fold_info = data_serie.fold_infos[fold]
        explainer = shap.TreeExplainer(fold_info.lgb_models)
